...
MarkerClusterer.prototype.AddCluster = function(clat, clng, csize) {
  ...
  $.extend(CI, {sums_ : {text : csize, index: index}, url_ : style['url'], width_ : style['width'], height_ : style['height'], averageCenter_: style['averageCenter'], anchorIcon_: [clat, clng]});
